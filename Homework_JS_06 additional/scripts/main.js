...
let book = [
    ...
    {name:`boyWhoLived full`, pageCount: 18, authors: ['AAA'], genre: ['aaa', 'ccc']},
    ...
    {name:`afterword`, pageCount: 19, authors: ['CCC'], genre: ['aaa', 'bbb', 'ccc', 'fff']}
...
let maxGenre = (books) =>
    {
        let maxCount =  books.sort(function (book1, book2)
                                        {
        ...
        books = books.reduce((bookWithMax, book) =>
                            {
                                if (book.genre.length === maxCount)
                                {
                                     bookWithMax.push(book);
                                }
                                return bookWithMax;
                            }
                , []);
...
// - знайти книжку/ки з найдовшою назвою
    ...
    console.log(maxName(book));

// - знайти книжку/ки які писали 2 автори

console.log('знайти книжку/ки які писали 2 автори ');

let twoAuthors =  book.reduce((bookWithMax, book) =>
    {
...
console.log('знайти книжку/ки які писали 1 автор ');

let oneAuthors =  book.reduce((bookWithMax, book) =>
    {
